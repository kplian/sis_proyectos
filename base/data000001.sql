...
/***********************************I-DAT-EGS-PRO-ETR-2261-23/12/2020****************************************/
select conta.f_import_tplantilla_comprobante ('insert','PRO-CIE3V3','pro.f_gestionar_cbte_proyecto_cierre_eliminacion','id_proyecto','PRO','{$tabla.glosa_cbte}','pro.f_gestionar_cbte_proyecto_cierre','{$tabla.fecha_fin}','activo','ENDE TRANSMISION S.A.','{$tabla.id_depto_conta}','contable','','pro.v_cbte_cierre_proy_3','DIARIOCON','{$tabla.id_moneda}','{$tabla.id_gestion}','{$tabla.id_proyecto},{$tabla.id_depto_conta}','no','no','no','','','','','{$tabla.nro_tramite_cierre}','','','','','','Comprobante de Redistribución por AITB de gestiones pasadas al cierre del proyecto V3','','','','','');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','PRO-CIE3V3','Debe','debe','no','si','','{$tabla.denominacion}','CIEPRO','','{$tabla.importe_actualiz}','{$tabla.id_clasificacion}','','no','','','','si','','id_proyecto','','Activos','{$tabla.importe_actualiz}',NULL,'simple','','','no','','','','','','','','2','','pro.v_cbte_cierre_proy_3_debe_detV3',NULL,'','CCDEPCON','','','todos','','si','','','si');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','PRO-CIE3V3','Debe Almacenes','debe','no','si','','{$tabla.denominacion}','PRO-CIEREVACT','','{$tabla.importe_actualiz}','{$tabla.id_almacen}','','no','','','','si','','id_proyecto','','Activos','{$tabla.importe_actualiz}',NULL,'simple','','','no','','','','','','','','2','','pro.v_cbte_cierre_proy_3_debe_det_alm',NULL,'','CCDEPCON','','','todos','','si','','','si');
select conta.f_import_tdetalle_plantilla_comprobante ('insert','PRO-CIE3V3','GASTO','debe','no','si','','{$tabla.denominacion}','PRO-CIEGANT','','{$tabla.importe_actualiz}','{$tabla.id_clasificacion}','','no','','','','si','','id_proyecto','','Importe que no se activa, sino se va al gasto','{$tabla.importe_actualiz}',NULL,'simple','','','no','','','','','','','','2','','pro.v_cbte_cierre_proy_3_gasto_debe_detV3',NULL,'','CCDEPCON','','','todos','','si','','','si');
