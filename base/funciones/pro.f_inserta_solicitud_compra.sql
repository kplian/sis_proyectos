...
#ISSUE				FECHA				AUTOR				DESCRIPCION
   ...
   #43              05/11/2019          EGS                Se agrega la ot al hacer una solicitud de compra
 ***************************************************************************/
 */
         ...
         --insertando la solicitud de compra de la invitacion el precontrato y el comprometer_87 ya vienen directo de la vista de solicitud de compras
			...
			FOR v_record_detalle in (
    			SELECT
                 ...
                 uc.id_orden_trabajo
                FROM pro.tinvitacion_det invd
                LEFT JOIN pro.tunidad_constructiva uc on invd.id_unidad_constructiva = uc.id_unidad_constructiva
             ...
             if v_record_detalle.id_unidad_constructiva is null then --#43
                raise exception 'Es necesario que el detalle ingrese una unidad constructiva';
			  end if;
              ...
              v_tabla_2 = pxp.f_crear_parametro(ARRAY[
                              ...
                              ARRAY[
                                 ...
                                 COALESCE(v_record_detalle.id_orden_trabajo::varchar,''), --'id_orden_trabajo'#43
