CREATE OR REPLACE FUNCTION pro.f_fun_inicio_fase_wf (
  p_id_fase integer,
...
/**************************************************************************
 SISTEMA:       Sistema 
 FUNCION:       pro.f_fun_inicio_fase_wf
                
 DESCRIPCION:   Actualiza los estados despues del registro 
 AUTOR:         EGS
 FECHA:         
 COMENTARIOS: 
...
BEGIN
    ...
    v_nombre_funcion = 'pro.f_fun_inicio_fase_wf';
