CREATE OR REPLACE FUNCTION pro.f_fun_inicio_invitacion_wf (
...
/**************************************************************************
 ...
 FUNCION:       pro.f_fun_inicio_invitacion_wf
...
BEGIN
    ...
    v_nombre_funcion = 'pro.f_fun_inicio_invitacion_wf';
    ...
    where c.id_invitacion = p_id_invitacion;
...
ALTER FUNCTION pro.f_fun_inicio_invitacion_wf (p_id_invitacion integer, p_id_usuario integer, p_id_usuario_ai integer, p_usuario_ai varchar, p_id_estado_wf integer, p_id_proceso_wf integer, p_codigo_estado varchar, p_id_depto_lb integer, p_id_cuenta_bancaria integer, p_estado_anterior varchar)
  OWNER TO postgres;