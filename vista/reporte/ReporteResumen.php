...
?>
<script>
	Phx.vista.ReporteResumen = Ext.extend(Phx.frmInterfaz, {
		constructor : function(config) {
			
			this.maestro=config;
			
			console.log('maestro',this.maestro);
			this.Atributos[0].valorInicial=this.maestro.id_proyecto
			Phx.vista.ReporteResumen.superclass.constructor.call(this, config);
			this.init();
			this.iniciarEventos();
		...
		ActSave : '../../sis_proyectos/control/Reporte/listarReportes',
		topBar : true,
		botones : false,
