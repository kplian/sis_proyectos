...
?>
<script>
    Phx.vista.ComponenteConceptoIngasBase=Ext.extend(Phx.gridInterfaz,{
            nombreVista:'ComponenteConceptoIngasBase',
            constructor:function(config){
                this.maestro=config.maestro;
                //llama al constructor de la clase padre
                Phx.vista.ComponenteConceptoIngasBase.superclass.constructor.call(this,config);
                this.init();
