...
/**
*@package pXP
*@file gen-UnidadComingdetBase.php
*@author  (egutierrez)
...
?>
<script>
Phx.vista.UnidadComingdetBase=Ext.extend(Phx.gridInterfaz,{
    nombreVista: 'UnidadComingdetBase',
	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
		Phx.vista.UnidadComingdetBase.superclass.constructor.call(this,config);
		this.init();
